...
function plotToDataURL({ series, title, unit, color, durationSec }) {
  ...
  ctx.fillStyle = '#111'; ctx.font = 'bold 14px Liberation Sans'; ctx.fillText(title, mL, 18);
  ctx.fillStyle = '#333'; ctx.font = '12px Liberation Sans'; ctx.fillText(unit, 12, mT + 12);
  for (let j = 0; j <= 6; j++) {
